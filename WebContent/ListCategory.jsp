<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="java.util.List, com.netpace.iem.ahmed.model.Category"%>
...
<body>
	...
	<%-- 				<td><a href="?delete=<%= category.getId()  %>">Click</a></td> --%>
	<!-- 			</tr> -->
	<%-- 		<% } %> --%>
	<!-- 		</tbody> -->
	<!-- 	</table> -->
	...
	<%-- <%@ include file="NewCategory.html"%>
 --%>
	<script>
		$(function() {
			$("#list").jqGrid(
					{
						url : "Category?output=json",
						datatype : "json",
						mtype : "GET",
						jsonReader: {
							root: "result",
						...
						editurl:"Category?output=json&edit=true"
					});
			$("#add").click(function(){
